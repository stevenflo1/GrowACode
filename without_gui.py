...
def get_ip_info(widget=None):
    """
    Fetch IP info and optionally display in a Text widget.
    If widget=None, function returns the output for testing.
    """
...
if __name__ == "__main__":
    ...
    # Button
    fetch_button = ttk.Button(card, text="Get My IP Information",
                              style="Blue.TButton",
